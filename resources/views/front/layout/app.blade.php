                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="useful-links">
                                ...
                                @if(isset($global_page_data) && $global_page_data->terms_status == 1)

                                <li><a href="{{ route('terms') }}">{{ $global_page_data->terms_heading }}</a></li>
                                @endif
                                
                                @if(isset($global_page_data) && $global_page_data->privacy_status == 1)

                                <li><a href="{{ route('privacy') }}">{{ $global_page_data->privacy_heading }}</a></li>
                                @endif

                                @if(isset($global_page_data) && $global_page_data->faq_status == 1)
